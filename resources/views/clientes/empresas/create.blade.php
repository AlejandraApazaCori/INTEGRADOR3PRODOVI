            ...
            <div class="relative z-10 px-8 py-8">
                <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        <h1 class="text-3xl font-bold text-white mb-1">Nueva Empresa</h1>
                        <p style="color: #bfdbfe; font-size: 0.9rem;">Registra tu empresa para comenzar a gestionar tu negocio</p>
                    </div>
            ...
            <div class="px-8 py-6 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-indigo-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-0.5">Completa la información para registrar tu empresa</p>
                    </div>
                </div>
            </div>
            
            <!-- Formulario -->
            <form action="{{ route('empresas.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-indigo-400 transition-all duration-200 bg-gray-50/50 hover:bg-gray-50">
                            ...
                            >
                            <div id="logo-preview" class="flex flex-col items-center justify-center">
                                <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-3"></i>
                                <p class="text-sm text-gray-500">Haz clic o arrastra tu logo aquí</p>
                                <p class="text-xs text-gray-400 mt-1">Formatos: JPG, PNG, SVG (Máx. 2MB)</p>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-6 border-t border-gray-200">
                    <a href="{{ route('clientes.dashboard') }}" class="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-all duration-200 font-medium">
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                preview.innerHTML = `
                    ...
                    <p class="text-sm text-gray-500 mt-2">Logo cargado correctamente</p>
                `;
