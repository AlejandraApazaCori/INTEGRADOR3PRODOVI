...
@section('content')
    <div class="min-h-screen" style="background: #ffffff;">
        ...
        <div class="users-page-content">
            ...
            <style>
                .users-page-content { margin-right: 24px; margin-left: 24px; }
                .users-filter-grid { display: grid; grid-template-columns: repeat(12,minmax(0,1fr)); gap: 12px; align-items: end; }
                ...
                .custom-filter-menu { position: absolute; top: calc(100% + 8px); right: 0; left: 0; overflow-y: auto; max-height: 250px; padding: 7px; border: 1px solid #e2e8d8; border-radius: 13px; background: #fff; box-shadow: 0 16px 35px rgba(31,41,55,.16); }
                ...
                .custom-calendar { position: absolute; top: calc(100% + 8px); left: 0; width: min(310px,calc(100vw - 28px)); padding: 14px; border: 1px solid #dce7cc; border-radius: 16px; background: #fff; box-shadow: 0 18px 40px rgba(31,41,55,.18); }.custom-calendar-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; }.custom-calendar-header strong { color: #34451f; font-size: .86rem; text-transform: capitalize; }.custom-calendar-header button { width: 34px; height: 34px; display: grid; place-items: center; border: 0; border-radius: 9px; background: #edf4e4; color: #638524; }.custom-calendar-weekdays,.custom-calendar-days { display: grid; grid-template-columns: repeat(7,1fr); gap: 4px; }.custom-calendar-weekdays { margin-bottom: 5px; }.custom-calendar-weekdays span { color: #9aa18f; text-align: center; font-size: .61rem; font-weight: 900; }.custom-calendar-days button,.custom-calendar-days span { aspect-ratio: 1; display: grid; place-items: center; border: 0; border-radius: 9px; background: transparent; color: #48513e; font-size: .73rem; font-weight: 700; }.custom-calendar-days button:hover { background: #edf4e4; color: #587923; }.custom-calendar-days button.is-today { box-shadow: inset 0 0 0 1px #7da533; }.custom-calendar-days button.is-selected { background: #7da533; color: #fff; box-shadow: 0 5px 12px rgba(125,165,51,.25); }.custom-calendar-days button:disabled { cursor: not-allowed; color: #d1d5db; background: transparent; box-shadow: none; }.custom-calendar-clear { width: 100%; margin-top: 10px; padding: 9px; border: 0; border-radius: 9px; background: #f4f6f1; color: #758069; font-size: .7rem; font-weight: 800; }.custom-calendar-clear i { margin-right: 6px; }
                ...
                .users-reports-section { padding-top: 5px; }
