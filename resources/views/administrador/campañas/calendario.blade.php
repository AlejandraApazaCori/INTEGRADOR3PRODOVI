            ...
            <section class="planning-workspace">
                <header class="planning-workspace-header">
                    ...
                    <div class="planning-view-switch" role="group" aria-label="Cambiar vista">
                        <button type="button" data-planning-view="calendar" aria-pressed="false"><i class="fas fa-calendar-days"></i> Calendario</button>
                        <button type="button" class="is-active" data-planning-view="gantt" aria-pressed="true"><i class="fas fa-chart-gantt"></i> Diagrama de Gantt</button>
                    </div>
                </header>

                <div id="calendar-view" class="planning-view hidden">
                ...
                <div id="gantt-view" class="planning-view">
...
<style>
    ...
    .planning-hero{position:relative;min-height:180px;overflow:hidden;background:linear-gradient(135deg,#ef6c22 25%,transparent 25%) -50px 0,linear-gradient(225deg,#ef6c22 25%,transparent 25%) -50px 0,linear-gradient(315deg,#ef6c22 25%,transparent 25%),linear-gradient(45deg,#ef6c22 25%,transparent 25%),linear-gradient(to bottom,#ef6c22 0%,#c94f0c 100%);background-size:100px 100px,100px 100px,100px 100px,100px 100px,100% 100%;background-color:#c94f0c}.planning-hero-overlay{position:absolute;inset:0;background:linear-gradient(rgba(74,31,8,.2),rgba(74,31,8,.2)),radial-gradient(circle at 0 0,rgba(255,255,255,.2),transparent 50%),radial-gradient(circle at 100% 100%,rgba(255,255,255,.2),transparent 50%)}
...
<script>
    ...
    function priorityColor(priority) {
        return { urgente:'#c94f0c', alta:'#ef6c22', media:'#5b2b76', baja:'#7da533' }[priority] || '#117e8c';
    }
    ...
    function renderGantt() {
        ...
        planningEvents.forEach(event => {
            ...
            bar.style.setProperty('--bar-color', priorityColor(event.extendedProps?.prioridad));
