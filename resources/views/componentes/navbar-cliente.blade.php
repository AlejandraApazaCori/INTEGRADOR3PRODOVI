...
<style>
    ...
    *::-webkit-scrollbar-thumb:hover{background:#0d6974}
    ...
    .client-navbar{position:sticky;z-index:1200;top:0;width:100%;border-bottom:4px solid var(--client-orange);background:#242426;color:#fff;box-shadow:0 8px 24px rgba(0,0,0,.16)}
    ...
    html[data-client-theme="dark"] .notification-menu{border-color:#444047;background:#242426;color:#ddd8df}
